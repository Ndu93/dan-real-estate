      ...
      <div className="container mx-auto min-h-[800px] mb-14">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h3 className="text-lg b-4 ">{house.address}</h3>
          </div>
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          <div className="max-w-[768px]">
            <div className="mb-8">
              <img className="Lg-img" src={house.imageLg} alt="LgImage" />
            </div>
          ...
          <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8">
            <div className="flex items-center gap-x-4 mb-8">
              <div className="w-20 h-20 p-[5px] border border-gray-300 rounded-full">
                <img
                  className="img-agent"
            ...
            <form className="flex flex-col gap-y-4">
              ...
              <div className="flex gap-x-2">
                ...
                <button className="border-violet-700 hover:border-violet-500 text-violet-700 hover:text-violet-500 rounded p-4 text-sm w-full transition">
                  Call
                </button>
              </div>
            </form>
